            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-white/60 max-w-2xl">
                        AI-powered thematic analysis of {metadata?.total_texts || 271} student comments via Gemini 2.5 Pro.
                        Each theme includes representative verbatim quotes as &quot;receipts&quot; for decision-making.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                        ...
                        <div className="text-sm text-white/50">Comments Analyzed</div>
                    </div>
                    <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                        <div className="text-2xl font-bold text-white">
                ...
                <div className="mt-8 sm:mt-12 p-4 sm:p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
                    ...
                    <p className="text-white/60 text-sm leading-relaxed">
                        Themes are identified by Gemini 2.5 Pro performing full qualitative thematic analysis
                        on all student comments in a single pass. Comments can relate to multiple themes
                        (multi-label), so theme counts may exceed total comments. Representative quotes
                        are curated by the LLM to best capture each theme&apos;s core student sentiment.
                    </p>
                </div>
            </main>
        </div>
